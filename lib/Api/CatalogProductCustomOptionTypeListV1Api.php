...
class CatalogProductCustomOptionTypeListV1Api
{
     ...
     * @return \Webgriffe\MagentoApiClient\Model\CatalogDataProductCustomOptionTypeInterface[]
     */
     ...
     *
     * @throws \Webgriffe\MagentoApiClient\ApiException on non-2xx response
     * @return array of \Webgriffe\MagentoApiClient\Model\CatalogDataProductCustomOptionTypeInterface[], HTTP status code, HTTP response headers (array of strings)
     */
    public function catalogProductCustomOptionTypeListV1GetItemsGetWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Webgriffe\MagentoApiClient\Model\CatalogDataProductCustomOptionTypeInterface[]',
                '/V1/products/options/types'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Webgriffe\MagentoApiClient\Model\CatalogDataProductCustomOptionTypeInterface[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Webgriffe\MagentoApiClient\Model\CatalogDataProductCustomOptionTypeInterface[]', $e->getResponseHeaders());
