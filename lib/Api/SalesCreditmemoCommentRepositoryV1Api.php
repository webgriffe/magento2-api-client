...
class SalesCreditmemoCommentRepositoryV1Api
{
     ...
     * @param \Webgriffe\MagentoApiClient\Model\Body78 $body  (optional)
     ...
     * @param \Webgriffe\MagentoApiClient\Model\Body78 $body  (optional)
     * @throws \Webgriffe\MagentoApiClient\ApiException on non-2xx response
     * @return array of \Webgriffe\MagentoApiClient\Model\SalesDataCreditmemoCommentInterface, HTTP status code, HTTP response headers (array of strings)
     */
    public function salesCreditmemoCommentRepositoryV1SavePostWithHttpInfo($id, $body = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Webgriffe\MagentoApiClient\Model\SalesDataCreditmemoCommentInterface',
                '/V1/creditmemo/{id}/comments'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Webgriffe\MagentoApiClient\Model\SalesDataCreditmemoCommentInterface', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Webgriffe\MagentoApiClient\Model\SalesDataCreditmemoCommentInterface', $e->getResponseHeaders());
