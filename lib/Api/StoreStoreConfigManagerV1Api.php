...
class StoreStoreConfigManagerV1Api
{
     ...
     * @return \Webgriffe\MagentoApiClient\Model\StoreDataStoreConfigInterface[]
     */
     ...
     * @param string[] $storeCodes  (optional)
     * @throws \Webgriffe\MagentoApiClient\ApiException on non-2xx response
     * @return array of \Webgriffe\MagentoApiClient\Model\StoreDataStoreConfigInterface[], HTTP status code, HTTP response headers (array of strings)
     */
    public function storeStoreConfigManagerV1GetStoreConfigsGetWithHttpInfo($storeCodes = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Webgriffe\MagentoApiClient\Model\StoreDataStoreConfigInterface[]',
                '/V1/store/storeConfigs'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Webgriffe\MagentoApiClient\Model\StoreDataStoreConfigInterface[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Webgriffe\MagentoApiClient\Model\StoreDataStoreConfigInterface[]', $e->getResponseHeaders());
