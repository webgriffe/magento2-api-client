...
class CatalogProductAttributeTypesListV1Api
{
     ...
     * @return \Webgriffe\MagentoApiClient\Model\CatalogDataProductAttributeTypeInterface[]
     */
     ...
     *
     * @throws \Webgriffe\MagentoApiClient\ApiException on non-2xx response
     * @return array of \Webgriffe\MagentoApiClient\Model\CatalogDataProductAttributeTypeInterface[], HTTP status code, HTTP response headers (array of strings)
     */
    public function catalogProductAttributeTypesListV1GetItemsGetWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Webgriffe\MagentoApiClient\Model\CatalogDataProductAttributeTypeInterface[]',
                '/V1/products/attributes/types'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Webgriffe\MagentoApiClient\Model\CatalogDataProductAttributeTypeInterface[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Webgriffe\MagentoApiClient\Model\CatalogDataProductAttributeTypeInterface[]', $e->getResponseHeaders());
