...
class QuoteGuestCartManagementV1Api
{
     ...
     * @param \Webgriffe\MagentoApiClient\Webgriffe\MagentoApiClient\Model\Body50 $body  (optional)
     ...
     *
     * @param string $cartId The cart ID. (required)
     * @param \Webgriffe\MagentoApiClient\Webgriffe\MagentoApiClient\Model\Body51 $body  (optional)
     * @throws \Webgriffe\MagentoApiClient\ApiException on non-2xx response
     * @return int
     */
